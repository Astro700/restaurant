...
<head>
    ...
    <title>Blue Moon Restaurant| Menu</title>
...
<body>
	...
	<div class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/bg-img/a15.jpg)">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
	...
	<div class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/bg-img/a13.jpg)">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="kt-single-dish wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="dish-info">
                            <h6 class="dish-name">Mushrooms Pizza</h6>
				...
				<div class="col-12 col-sm-6 col-md-4">
                    <div class="kt-single-dish wow fadeInUp" data-wow-delay="2.5s">
				...
				<div class="col-12 col-sm-6 col-md-4">
                    <div class="kt-single-dish wow fadeInUp" data-wow-delay="3.0s">
